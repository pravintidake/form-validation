                        ...
                        <div className="modal-body">
                            <form onSubmit={handleSubmit} noValidate>
                                ...
                                <div className="mb-3">
                                    ...
                                    <input autoComplete="off" className={`input ${errors.author && 'is-danger'} form-control`} type="text" name="author" onChange={handleChange} value={values.author || ''} required />
                                    {errors.author && (
                                        <p className="help is-danger text-danger">{errors.author}</p>
                                    )}
                                </div>
                                <div className="mb-3">
